export const styles = {
  ...
  options: {
    ...
    remember: {
      ...
      checkboxWrapper: 'flex h-5 items-center',

      checkbox:
        'h-4 w-4 rounded border border-gray-300 bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600',
